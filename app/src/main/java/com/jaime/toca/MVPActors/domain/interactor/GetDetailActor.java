...
public interface GetDetailActor extends Interactor{

    void requestActorDetail (String movieId);

    void sendDetailActorToPresenter (ActorDetail actorDetailResponse);

    void actorDetailResponse(ActorDetail actorDetail);
}
